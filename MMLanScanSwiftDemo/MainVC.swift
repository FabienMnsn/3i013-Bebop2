...
class MainVC: UIViewController, MainPresenterDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func mainPresenterIPSearchFinished() {
        ...
        self.showAlert(title: "Scan terminé", message: "Nombre d'appareils connectés au réseau local : \(self.presenter.connectedDevices.count)")
    }
    ...
    func mainPresenterIPSearchFailed() {
        ...
        self.hideProgressBar()
        self.showAlert(title: "Le scan a échoué", message: "Veuillez vérifier que vous êtes bien connecté à un réseau WiFi avant de démarrer le scan du LAN")
    }
