...
\newpage
    ...
    \end{enumerate}
    Il permet égaement la réception du flux vidéo et de l'état du drone.
     ...
     L'application IOS permet dans un permier temps de scanner le réseau afin de se connecté au réseau du serveur local.
     (VLC ??)
     \newline
     dans un second temps elle permet de visualiser le retour video du drone en direct.
     Le flux video est envoyé au SDK Parrot et est ensuite diffusé en streaming sur le serveur local.
     \newline
     L'application affiche à l'aide d'une WK Webview le retour vidéo.
        \vspace*{0.3cm}
	    \begin{center}
		\begin{figure}[!h]
